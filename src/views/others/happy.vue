...
import happyDatas from '../../mock/school'
...
export default {
  ...
  created() {
    //  console.log(happyDatas)
      this.happydata = happyDatas.happy.happyData;
      this.happyLink = happyDatas.happy.happyLink;
  },
  mounted() {
      this.createHappy1();
  },

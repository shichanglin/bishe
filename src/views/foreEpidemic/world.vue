...
import worldData from '../../mock/school'
...
export default {
  ...
  created() {
    this.worldData  = worldData.world.worldData
  },
  mounted() {
    this.drawLine();
  },
...
jsonp(jsonpURL, function(data){
  ...
  let option = {
        ...
        xAxis: {
            ...
            axisLabel: {
                rotate: 45,
                interval: 1, //类目间隔 设置为 1，表示(隔一个标签显示一个标签)
                textStyle: {
                    color: '#fff',
                    fontSize: 12
                },
...
<style  scoped>
#myChart{
  background: url('../../assets/bgworld.png');
}
</style>

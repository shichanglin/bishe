<template>
  <div class="content">
    <!-- 客户在国内分布范围 -->
    <div id="from" class="left"></div>
    <div class="right">
      <div class="num3">
        <p>客服中心</p>
        <div class="serveBox">
          <el-table :data="tableData" height="300" style="width: 100%;background:#021D31;">
            <el-table-column prop="online" label="在线状态" width="100"></el-table-column>
            <el-table-column prop="name" label="姓名" width="100"></el-table-column>
            <el-table-column prop="address" label="负责区域"></el-table-column>
          </el-table>
        </div>
      </div>
      <div id="time" class="num4">用户活跃时间</div>
    </div>
...
export default {
  ...
  methods: {
    userFrom() {
      let myChart = this.$echarts.init(document.getElementById("from"));
      var namedata = [
        { name: "张" },
        { name: "刘" },
        { name: "李" },
      ...
      function getAddress(num, type) {
        ...
        switch (type) {
          case 1:
            addstr = "在" + chinaDatas[num].name + "-车辆报警";
            break;
          case 2:
            addstr = "在" + chinaDatas[num].name + "-需要支援";
            break;
          default:
            addstr = "在" + chinaDatas[num].name + "-车辆补胎";
            break;
        }
        return addstr;
      }
